...
def main(args):
    ...
    run = wandb.init() # project="has_kipa", entity="hutom_miai")  # project=f'{args.TARGET_NAME}', entity='has_in_tom') 
...
def get_arguments():
    ...
    parser.add_argument('--window', default = '0,2000',  dest='CONTRAST', type=str)# default='-150,300', dest='CONTRAST', type=str)
    ...
    parser.add_argument('--input', default='140,140,160', dest='input_shape', type=str)
